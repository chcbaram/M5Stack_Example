...
void loop() {
  ...
  if (Xbox.XboxConnected) {
    if (Xbox.getButtonPress(BLACK_) || Xbox.getButtonPress(WHITE_)) {
      Serial.print("BLACK_: ");
      Serial.print(Xbox.getButtonPress(BLACK_));
      Serial.print("\tWHITE: ");
      Serial.println(Xbox.getButtonPress(WHITE_));
      Xbox.setRumbleOn(Xbox.getButtonPress(BLACK_), Xbox.getButtonPress(WHITE_));
    } else
