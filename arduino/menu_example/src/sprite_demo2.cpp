...
static TFT_eSprite img = TFT_eSprite(&M5.Lcd);  // Create Sprite object "img" with pointer to "tft" object
//                                       // the pointer is used by pushSprite() to push it onto the TFT
static void drawStar(int x, int y, int star_color);
static void numberBox(int x, int y, float num );

void sprite2_setup(void) {
